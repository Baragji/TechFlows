...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/10 via-white to-secondary/10 overflow-hidden"
    >
      <div className="container mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            >
              Vi specialiserer os i udvikling af apps, hjemmesider og automatisering af
              arbejdsprocesser med fokus på innovation og effektivitet
            </motion.p>
