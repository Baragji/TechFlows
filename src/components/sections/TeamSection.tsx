  ...
  const teamMembers: TeamMember[] = [
    {
      ...
      description: 'Passioneret om at skabe innovative teknologiløsninger der gør en reel forskel for virksomheder.',
      initials: 'YB',
    ...
    },
    {
      ...
      description: 'Ekspert i moderne webudvikling og automatisering med fokus på skalerbare løsninger.',
      initials: 'TS',
        ...
        >
          <div className="bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl p-8 max-w-2xl mx-auto">
            ...
            <p className="text-text-light mb-6">
              Vi ser frem til at høre om dit projekt og hvordan vi kan hjælpe dig med at nå dine mål.
            </p>
            <motion.a
              href="/#contact"
