...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt: 'Beskyt din virksomhed mod cybertrusler med disse praktiske tips og best practices for små og mellemstore virksomheder.',
    author: 'Tech Specialist',
  ...
  },
  {
    ...
    excerpt: 'Lær hvordan du kan udvikle miljøvenlige websites der både performer godt og reducerer dit CO2-aftryk.',
    author: 'Yousef Beshara',
  ...
  },
  {
    ...
    excerpt: 'Hvordan du bruger data analytics til at træffe bedre forretningsbeslutninger og optimere din digitale strategi.',
    author: 'Tech Specialist',
...
const categories = ['Alle', 'Webudvikling', 'SEO', 'Automatisering', 'Sikkerhed', 'Bæredygtighed', 'Analytics']
