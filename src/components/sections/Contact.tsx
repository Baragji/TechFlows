            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    />
                    {getError('name') && isTouched('name') && <p className="mt-1 text-sm text-red-500">{getError('name')}</p>}
                  </div>
                  ...
                  <div>
                    ...
                    />
                    {getError('email') && isTouched('email') && <p className="mt-1 text-sm text-red-500">{getError('email')}</p>}
                  </div>
                </div>
                ...
                <div>
                  ...
                  />
                  {getError('message') && isTouched('message') && <p className="mt-1 text-sm text-red-500">{getError('message')}</p>}
                </div>
