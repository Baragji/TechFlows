    ...
    <section ref={ref} className="py-20 bg-glass-dark/20">
      <div className="container mx-auto px-4">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Vores Resultater</h2>
          <p className="text-xl text-white/70 max-w-3xl mx-auto leading-relaxed">
            Tallene taler for sig selv. Vi leverer konsistent høj kvalitet og ekstraordinære
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          {stats.map((stat, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="bg-glass-light backdrop-blur-xs rounded-2xl p-8 border border-white/10 hover:border-white/20 transition-all duration-300 hover:bg-glass-medium group-hover:scale-105">
                {/* Icon */}
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <div className="bg-glass-light backdrop-blur-xs rounded-2xl p-8 border border-white/10 max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <div className="text-white/70">Stigning i online synlighed</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-white/70">ROI på digitale investeringer</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-white/70">Reduktion i operationelle omkostninger</div>
              </div>
            </div>
          </div>
        </motion.div>
