      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Fra hjemmesider og apps til automatisering og digital strategi - vi leverer
              skræddersyede løsninger der transformerer din forretning og skaber målbare resultater.
            </motion.p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/70 mb-8 leading-relaxed">
              Lad os diskutere hvordan vores løsninger kan hjælpe din virksomhed med at vokse og
              innovere
            </p>
